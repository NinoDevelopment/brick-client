  ...
  return (
    <Container className={styles.main}>
      ...
      <p className={styles.intro}>
        ...
        которую интернет-сайт «kzk.ooo», расположенный на доменном имени{" "}
        <a href="https://kzk.ooo">https://kzk.ooo</a>, может получить о
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          <li>
            ...
            сайта)» — уполномоченные сотрудники на управление сайтом,
            действующие от имени kzk.ooo, которые организуют и (или)
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          kzk.ooo. Сайт не контролирует и не несёт ответственность за сайты
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>3.2.5. место жительства Пользователя.</li>
        </ul>
        <p>
        ...
        <p>
          3.4. Любая иная персональная информация, не оговорённая выше (история
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            4.1.6. Создания учётной записи для совершения покупок, если
            Пользователь дал согласие на создание учётной записи.
          </li>
          ...
          <li>
            ...
            рассылки и иных сведений от имени Сайта или от имени партнёров
            Сайта.
          </li>
          <li>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          Сайте «kzk.ooo», включая доставку Товара.
        </p>
        <p>
