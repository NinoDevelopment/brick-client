   ...
   return (
      <div className={styles.wrapper}>
         <div className={styles.content}>
            ...
            <h5>
               Погрузитесь в нашу галерею, чтобы найти вдохновение для вашего будущего проекта. 
               Изысканные дизайны, инновационные концепции и качественные решения - 
               все это ждет вас в нашей коллекции изображений.
            </h5>
