...
export const SEO_FAQ = {
  title: `Частые вопросы | Кирпич, доставка, оплата | ${SITE_NAME}`,
  description:
    "FAQ: доставка кирпича по Нижнему Новгороду и области, оплата, самовывоз, расчёт количества и оформление заказа с завода Ковернино.",
};
...
export const SEO_PRIVACY = {
  ...
  description:
    "Политика обработки персональных данных ООО «Кирпичный завод Ковернино»: цели, сроки, cookies, права субъекта.",
};

export const SEO_CONSENT = {
  title: `Согласие на обработку персональных данных | ${SITE_NAME}`,
  description:
    "Согласие на обработку персональных данных при заявке и заказе на сайте Кирпичного завода Ковернино.",
};
