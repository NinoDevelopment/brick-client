    ...
    <Container className={styles.main}>
      ...
      <div className={styles.block}>
        <p>
          ...
          которую Интернет-cайт «kzk.ooo», расположенный на доменном имени
          https://kzk.ooo, может получить о Пользователе во время использования
          сайта, программ и продуктов Интернет-сайта.
        </p>
      </div>
      ...
      <div className={styles.block}>
        ...
        <p>
          ...
          термины: <br />
          1.1.1.«Администрация сайта Интернет-сайта (далее – Администрация
          сайта) » – уполномоченные сотрудники на управления сайтом, действующие
          от имени casparus.ru, которые организуют и (или) осуществляет
          ...
          персональных данных или наличия иного законного основания. <br />
          1.1.5. «Пользователь сайта (далее Пользователь)» – лицо, имеющее
          доступ к Сайту, посредством сети Интернет и использующее Сайт. <br />
          ...
          построенной по протоколу IP. <br />
        </p>
      </div>
      ...
      <div className={styles.block}>
        ...
        <p>
          ...
          casparus.ru. Сайт не контролирует и не несет ответственность за сайты
          ...
          данных, предоставляемых Пользователем сайта. <br />
        </p>
      </div>
      ...
      <div className={styles.block}>
        ...
        <p>
          ...
          или при оформлении заказа для приобретения Товара. <br />
          ...
          установлен статистический скрипт системы ("пиксель"): <br />
          •IP адрес; <br />
          ...
          Сайта, требующим авторизации. <br />
      ...
      <div className={styles.block}>
        ...
        <p>
          ...
          Сайте «casparus.ru», включая доставку Товара. <br />
      ...
      <div className={styles.block}>
        ...
        <p>
          ...
          между Пользователем Cайта и Администрацией сайта, обязательным
      ...
      <div className={styles.block}>
        ...
        <p>
          ...
          конфиденциальности следует сообщать указать раздел Сайта <br />
          9.4. Действующая Политика конфиденциальности размещена на странице по
          адресу https://casparus.ru/content/legal/ <br />
        </p>
      </div>
    </Container>
  );
