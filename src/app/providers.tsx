    ...
    <Provider store={store}>
      <PersistGate persistor={persistedStore}>
        <YMaps query={{ apikey: "f1423869-80d1-4c88-8150-8643fdf24b7b" }}>
          ...
          <h3 hidden>Купить кирпич в Нижнем Новгороде - Завод Ковернино</h3>
          <h4 hidden>
            красный кирпич, красный керамический кирпич, облицовочный кирпич,
            рядовой кирпич, одинарный кирпич, полуторный кирпич, двойной кирпич
            Нижний Новгород
          </h4>
          <h5 hidden>
            Кирпич от производителя по лучшим ценам в Нижнем Новгороде
          </h5>
          <h6 hidden>Кирпич Ковернино завод Нижегородская область</h6>
          <p hidden>
