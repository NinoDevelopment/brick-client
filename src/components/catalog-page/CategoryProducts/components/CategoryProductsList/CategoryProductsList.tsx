...
const CategoryProductsList = () => {
	...
	const { data, load } = useFetch<IProductId[]>(selected ? API_CATEGORY_ITEMS(selected) : API_PRODUCT, REQUEST_METHODS.GET, {});
	...
	const getSortPriceItems = (dataInner: Maybe<IProductId[]>) => {
		...
		if (priceSort === -1) {
			return dataInner.sort((a: IProductId, b: IProductId) => b.price - a.price)
		}
		if (priceSort === 1) {
			return dataInner.sort((a: IProductId, b: IProductId) => a.price - b.price)
		}
	};
