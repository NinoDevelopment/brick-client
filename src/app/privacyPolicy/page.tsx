		...
		<Container className={styles.main}>
			...
			<div className={styles.block}>
				<p>
					...
					действует в отношении всей информации, которую Интернет-cайт «brick-nn.sbs»,  расположенный на
					доменном имени https://brick-nn.sbs, может получить о Пользователе во время использования сайта,
