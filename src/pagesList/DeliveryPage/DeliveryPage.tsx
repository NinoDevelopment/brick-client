    ...
    <div className={styles.main}>
      ...
      <Container className={styles.content}>
        ...
        <section className={styles.section}>
          <h2>Доставка</h2>
          <p>
            Доставляем кирпич своим транспортом по{" "}
        ...
        <section className={styles.section}>
          <h2>Доставка кирпича по Нижнему Новгороду и области</h2>
          <p>
            Отдельная страница — у каждого города: Нижний Новгород, Дзержинск,
            Бор, Кстово и другие. Там маршруты, что обычно берут на стройку
            и как оформить заказ:
          </p>
